      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          <p>Hi! 👋 I'm Satwika Sridhar. <br/>
           ...
           I am a final-year Computer Science Engineering student at Vellore Institute of Technology, where I have nurtured my passion for data science. With a keen interest in this dynamic field, I have developed a diverse skill set encompassing data analysis, statistical modeling, and machine learning techniques.
Throughout my academic journey, I have actively pursued opportunities to enhance my technical knowledge. Engaging in challenging coursework and hands-on projects, I have gained proficiency in data manipulation, cleaning, visualization, and hypothesis testing. I have also explored various machine learning algorithms such as linear regression, decision trees, and clustering techniques, enabling me to build predictive models and optimize their performance.
I am eagerly seeking an entry-level position as a Data Scientist. With my strong analytical and programming skills, coupled with a collaborative mindset, I am ready to contribute to innovative solutions that drive meaningful business outcomes.
